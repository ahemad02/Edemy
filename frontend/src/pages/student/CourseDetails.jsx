...
const CourseDetails = () => {
  ...
  const enrollCourse = async () => {
    try {
      if (!userData) return toast.warn("Please login to enroll the course");
  ...
  return courseData ? (
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
        ...
        h-full z-1 bg-gradient-to-b from-cyan-200/70"
        ></div>

        <div className="max-w-xl z-10 text-gray-500">
          <h1 className=" md:text-5xl leading-tight md:leading-[36px] font-semibold text-gray-800 md:mb-10">
        ...
        <div
          className="course-card z-10 shadow custom-card rounded-t
